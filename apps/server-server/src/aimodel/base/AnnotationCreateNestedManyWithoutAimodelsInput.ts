...
@InputType()
class AnnotationCreateNestedManyWithoutAimodelsInput {
...
export { AnnotationCreateNestedManyWithoutAimodelsInput as AnnotationCreateNestedManyWithoutAimodelsInput };
